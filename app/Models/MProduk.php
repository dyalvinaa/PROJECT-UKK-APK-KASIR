...
class MProduk extends Model
{
    ...
    public function getProduk()
    {
        ...
        $produk->select('tbl_produk.id_produk, tbl_produk.kode_produk, tbl_produk.nama_produk,
         tbl_produk.harga_beli, tbl_produk.harga_jual, tbl_satuan.nama_satuan, tbl_kategori.nama_kategori, tbl_produk.stok');
    ...
    public function getProdukById($id = false)
    {
        ...
        $builder->select('tbl_produk.id_produk, tbl_produk.kode_produk, tbl_produk.nama_produk, tbl_produk.harga_beli, 
        tbl_produk.harga_jual, tbl_satuan.id_satuan, tbl_satuan.nama_satuan, tbl_kategori.id_kategori, tbl_kategori.nama_kategori, tbl_produk.stok');
